...
# 파일 경로 지정
file_path = "C:/Users/82109/Desktop/오픈소스프로젝트 자료/avoid-rocks-master/"

# Load the background image 
background_image = pygame.image.load(file_path+"background.jpg").convert()
pygame.display.set_caption("OSSP - DeepBug - Dodge v0.0.6")
...
class Fireball(object):
    ...
    def __init__(self):
        ...
        self.col = random.randint(1,4)
        # 1 - white # 2 - red # 3 - puple # 4 - green
...
def show_ranking1():
    ...
    while rank:
        for event in pygame.event.get():
            ...
            button("Menu",405,300,95,50,green,bright_green,game_intro)
